...
import com.evidence.blockchainevidence.subprotocols.SAD2;
import com.evidence.blockchainevidence.subprotocols.SM;
...
public class SET {
	...
	public SET(CipherPub _VA, CipherPub _VB, BigInteger _pub, PaillierT _paillier) {
		a = _VA;
		b = _VB;
		paillier = _paillier;
		pub = _pub;
	...
	public SET(CipherPub _VA, CipherPub _VB, PaillierT _paillier) {
		a = _VA;
		b = _VB;
		paillier = _paillier;
		pub = paillier.Hsigma;
